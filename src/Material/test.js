import * as THREE from '../build/three.module.js';
		...
		**/
		...
		function initObject() {
			...
			// var texture = THREE.ImageUtils.loadTexture("./tiger/images/nationalFlag.png");//加载纹理贴图
			...
			// 光环
			globeTextureLoader.load('./tiger/images/halo.png', function (texture) {
			...
			// 小地球
			globeTextureLoader.load('./tiger/images/smallEarth.png', function (texture) {
			...
			// 地球
			globeTextureLoader.load('./tiger/images/earth2.jpg', function (texture) {
